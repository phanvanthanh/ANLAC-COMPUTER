(function($) {
  ...
  */
  ...
  themChiTietPhieuNhap=function(_token, frmName, url, urlLoadData, className){
        loading('.error-mode');
        var formData = new FormData(frmName[0]);
        $.ajax({
            type: "POST",
            ...
            success:function(data){
              if(data.error==""){
                jQuery('.id').val(data.id_phieu_nhap);
                getById(_token, data.id_phieu_nhap, urlLoadData, className);
                errorLoader(".error-mode","");
              }else{
                errorLoader(".error-mode",data.error);
              }
      ...
      themChiTietPhieuXuat=function(_token, frmName, url, urlLoadData, className){
        loading('.error-mode');
        var formData = new FormData(frmName[0]);
        $.ajax({
            type: "POST",
            ...
            success:function(data){
              if(data.error==""){
                jQuery('.id').val(data.id_phieu_xuat);
                getById(_token, data.id_phieu_xuat, urlLoadData, className);
                errorLoader(".error-mode","");
              }else{
                errorLoader(".error-mode",data.error);
              }
      ...
      xoaChiTietPhieuNhap=function(_token, id, url, urlRefreshData, classNameRefreshData){
        loading('.error-mode');
        var xhr1;
        if(xhr1 && xhr1.readyState != 4){
            xhr1.abort(); //huy lenh ajax truoc do
        ...
        xhr1 = $.ajax({
            ...
            success:function(data){          
              ...
              if(data.error==""){
                errorLoader(".error-mode","");
                getById(_token, data.id_phieu_nhap, urlRefreshData, classNameRefreshData);
              }else{
                errorLoader(".error-mode",data.error);
              }
            },
      ...
      xoaChiTietPhieuXuat=function(_token, id, url, urlRefreshData, classNameRefreshData){
        loading('.error-mode');
        var xhr1;
        if(xhr1 && xhr1.readyState != 4){
            xhr1.abort(); //huy lenh ajax truoc do
        ...
        xhr1 = $.ajax({
            ...
            success:function(data){          
              ...
              if(data.error==""){
                errorLoader(".error-mode","");
                getById(_token, data.id_phieu_xuat, urlRefreshData, classNameRefreshData);
              }else{
                errorLoader(".error-mode",data.error);
              }
            },

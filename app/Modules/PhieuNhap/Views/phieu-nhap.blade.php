...
<link rel="stylesheet" href="{{ asset('public/css/autocomplete.css') }}">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <h4 class="text-danger">DANH SÁCH PHIẾU NHẬP KHO</h4>
                  </div>
                    <div class="col-6">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              <i class="fa fa-download icon-lg text-success"></i>
                              <div class="ml-3">
                                <p class="mb-0">Tổng số phiếu nhập</p>
                                <h6>{{number_format($thongKeChung['tong_so_phieu_nhap'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                <p class="mb-0">Tổng nợ</p>
                                @php
                                  $tongNo=$thongKeChung['dt_tong_thanh_tien']-($thongKeChung['dt_tong_giam_gia']+$thongKeChung['dt_da_thanh_toan']);
                                @endphp
                                <h6>$ {{number_format($tongNo,0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                ...
                <div class="text-right table-responsive">
                    <div class="btn-group mr-2">
                      <form class="forms-sample frm-import" id="frm-import" name="frm-import" method="POST" action="{{ route('import-phieu-nhap') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    <div class="btn-group mr-2">
                        <button class="btn btn-sm btn-vnpt btn-import"><i class="fa fa-sign-in"></i> Import phiếu nhập</button>
                    </div>

                    <div class="btn-group mr-2">
                        <a href="{{ route('export-phieu-nhap') }}" class="btn btn-sm btn-vnpt btn-export"><i class="fa fa-download"></i> Export phiếu nhập</a>
                    </div>

                    <div class="btn-group mr-2">
                        <button class="btn btn-sm btn-vnpt btn-load-form-them-moi" data-toggle="modal" data-target="#modal-them-moi"><i class="mdi mdi-plus-circle-outline"></i> Lập phiếu nhập kho</button>
                    </div>
                </div>
                <br>
         ...
         <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
               <div class="modal-header background-vnpt">
                  <h5 class="modal-title">LẬP PHIẾU NHẬP KHO</h5>
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-vnpt" data-dismiss="modal"><i class="icon-check"></i>Hoàn tất nhập kho</button>
               </div>
            </div>
         </div>
      </div>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      loadTable(_token, "{{ route('danh-sach-phieu-nhap') }}", '.load-danh-sach');

      $('.btn-load-form-them-moi').on('click',function(){
        getById(_token, "", "{{ route('phieu-nhap-single') }}", ".frm-them-moi"); // gọi sự kiện lấy dữ liệu theo id
      });

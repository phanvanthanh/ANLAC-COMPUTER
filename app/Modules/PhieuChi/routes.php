...
Route::group(
    ...
    function() {
        ...
        Route::get('phieu-chi-cho-duyet', [
            'as' => 'phieu-chi-cho-duyet',
            'uses' => 'PhieuChiController@phieuChiChoDuyet'
        ]);

        Route::post('danh-sach-phieu-chi-cho-duyet', [
            'as' => 'danh-sach-phieu-chi-cho-duyet',
            'uses' => 'PhieuChiController@danhSachPhieuChiChoDuyet'
        ]);

        Route::post('duyet-phieu-chi', [
            'as' => 'duyet-phieu-chi',
            'uses' => 'PhieuChiController@duyetPhieuChi'
        ]);
    }
);
		...
		<div class="row">
			<div class="col-10">
				...
				<div class="col-12 text-center">
					<h1 style="margin-top: 20px;">HÓA ĐƠN BÁN HÀNG</h1>
				</div>
			</div>
			<div class="col-2">
			...
			<div class="col-12">
				<table style="">
					...
					<tbody>
						...
						<tr>
							<td colspan="8">&nbsp;<b>Tổng cộng bằng chữ: <b style="font-size:15px;">@php echo Helper::chuyenSoThanhChu($tongCong); @endphp</b></b></td>
						</tr>
					</tbody>
				</table>

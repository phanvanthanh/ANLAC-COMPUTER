...
@section('content')
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <h4 class="text-danger">DANH SÁCH ĐỐI TÁC</h4>
                  </div>
                    <div class="col-6">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                <p class="mb-0">Tổng ĐT</p>
                                <h6>{{number_format($thongKeChung['dt_so_luong_doi_tac'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                <p class="mb-0">Tổng nhập</p>
                                <h6>{{number_format($thongKeChung['dt_tong_thanh_tien'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                ...
                                <h6>{{number_format($thongKeChung['dt_tong_giam_gia'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                ...
                                <h6>{{number_format($thongKeChung['dt_da_thanh_toan'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                ...
                <div class="text-right table-responsive">
                    ...
                    <div class="btn-group mr-2">
                      <form class="forms-sample frm-import" id="frm-import" name="frm-import" method="POST" action="{{ route('import-doi-tac') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    <div class="btn-group mr-2">
                        <button class="btn btn-sm btn-vnpt btn-import"><i class="mdi mdi-plus-circle-outline"></i> Import nhà cung cấp</button>
                    </div>


                    <div class="btn-group mr-2">
                        <button class="btn btn-sm btn-vnpt btn-load-form-them-moi" data-toggle="modal" data-target="#modal-them-moi"><i class="mdi mdi-plus-circle-outline"></i> Thêm nhà cung cấp</button>
                    </div>
                </div>
                <br>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      loadTable(_token, "{{ route('danh-sach-doi-tac') }}", '.load-danh-sach');

      $('.btn-them-moi').on('click',function(){
          themMoi(_token, $("form#frm-them-moi"), "{{ route('them-doi-tac') }}", "{{ route('danh-sach-doi-tac') }}", '.load-danh-sach');
          jQuery("#modal-them-moi").modal('hide');
      });

      $('.btn-load-form-them-moi').on('click',function(){
        getById(_token, "", "{{ route('doi-tac-single') }}", ".frm-them-moi"); // gọi sự kiện lấy dữ liệu theo id
      });

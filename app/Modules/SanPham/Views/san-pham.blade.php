...
@section('content')
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <h4 class="text-danger">DANH MỤC SẢN PHẨM</h4>
                  </div>
                    <div class="col-6">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                <p class="mb-0">Tổng số loại</p>
                                <h6>{{number_format($thongKeChung['sp_so_san_pham'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                <p class="mb-0">Tổng số lượng tồn</p>
                                <h6>{{number_format($thongKeChung['sp_so_long_ton'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex align-items-center justify-content-md-center">
                              ...
                              <div class="ml-3">
                                <p class="mb-0">Tổng tiền tồn</p>
                                <h6>$ {{number_format($thongKeChung['sp_tong_tien_ton'],0)}}</h6>
                              </div>
                          </div>
                      </div>
                    </div>
                ...
                <div class="text-right table-responsive">
                    <div class="btn-group mr-2">
                      <form class="forms-sample frm-import" id="frm-import" name="frm-import" method="POST" action="{{ route('import-san-pham') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    <div class="btn-group mr-2">
                        <button class="btn btn-sm btn-vnpt btn-import"><i class="mdi mdi-plus-circle-outline"></i> Import sản phẩm</button>
                    </div>


                    <div class="btn-group mr-2">
                        <button class="btn btn-sm btn-vnpt btn-load-form-them-moi" data-toggle="modal" data-target="#modal-them-moi"><i class="mdi mdi-plus-circle-outline"></i> Thêm sản phẩm</button>
                    </div>
                </div>
                <br>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-vnpt btn-them-moi"><i class="icon-check"></i>Tạo sản phẩm</button>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      loadTable(_token, "{{ route('danh-sach-san-pham') }}", '.load-danh-sach');

      $('.btn-them-moi').on('click',function(){
          themMoi(_token, $("form#frm-them-moi"), "{{ route('them-san-pham') }}", "{{ route('danh-sach-san-pham') }}", '.load-danh-sach');
          jQuery("#modal-them-moi").modal('hide');
      });

      $('.btn-load-form-them-moi').on('click',function(){
        getById(_token, "", "{{ route('san-pham-single') }}", ".frm-them-moi"); // gọi sự kiện lấy dữ liệu theo id
      });

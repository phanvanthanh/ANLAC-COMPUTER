@php use App\KhachHang; @endphp
@if($error=="")
  @php $checkData=0; @endphp
  @php if($data){$checkData=1;} @endphp
  @php $maKhachHang=KhachHang::taoMa(); @endphp
        ...
        <div class="form-group row">
          <label for="ten_khach_hang" class="col-sm-4 col-form-label ">Tên khách hàng</label>
          <div class="col-sm-8">
             <input type="Text" class="form-control ten_khach_hang" name="ten_khach_hang" placeholder="Vui lòng nhập tên đối tác" @if($checkData==1) value="{{$data['ten_khach_hang']}}" @endif>
          </div>
        </div>

        <div class="form-group row">
          <label for="ma_khach_hang" class="col-sm-4 col-form-label ">Mã khách hàng</label>
          <div class="col-sm-8">
             <input type="Text" class="form-control ma_khach_hang" name="ma_khach_hang" placeholder="Vui lòng nhập mã đối tác" @if($checkData==1) value="{{$data['ma_khach_hang']}}" @else value="{{$maKhachHang}}" @endif>
          </div>
        </div>
